...
log_file="${out_dir}/log/courtlistener_${run_ts}.log"
timing_log_file="${out_dir}/log/courtlistener_${run_ts}.timing.jsonl"
echo "Logging to $log_file"
echo "Timing events to $timing_log_file"
# PYTHONUNBUFFERED=1 \
# NEMOTRON_SHOW_PROGRESS=0 \
# NEMOTRON_EMBED_STEP_TIMING=1 \
# NEMOTRON_STAGE_TIMING=1 \
CUDA_VISIBLE_DEVICES=1 \
python /share/project/liuze/projects/contextual_mmemb/code/baseline_retrievers/Nemotron-ColEmbed/eval_nemotron_colembed_contextual-new-env.py \
