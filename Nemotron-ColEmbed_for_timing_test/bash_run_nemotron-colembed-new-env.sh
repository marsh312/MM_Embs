...
log_file="${out_dir}/log/arxiv_phy_${run_ts}.log"
timing_log_file="${out_dir}/log/arxiv_phy_${run_ts}.timing.jsonl"
echo "Logging to $log_file"
echo "Timing events to $timing_log_file"

CUDA_VISIBLE_DEVICES=3 python /share/project/liuze/projects/contextual_mmemb/code/baseline_retrievers/Nemotron-ColEmbed/eval_nemotron_colembed_contextual-new-env.py \
  --source arxiv_phy \
  --batch_size 32 \
