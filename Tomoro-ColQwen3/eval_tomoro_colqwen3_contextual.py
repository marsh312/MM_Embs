...
from tomoro_colqwen3_dataset import TomoroColQwen3QueryDataset, TomoroColQwen3CorpusDataset
from tomoro_colqwen3_model import TomoroColQwen3Embed
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="/share/project/shared_models/tomoro-colqwen3-embed-8b")
    ...
    output_dir = os.path.join(base_data_dir.replace("/testdatas", "/testdatas_results"), "Tomoro-ColQwen3", args.source)
    
    # 1. Init Model
    model = TomoroColQwen3Embed(model_path=args.model_path)
    ...
    try:
        ...
        query_ds = TomoroColQwen3QueryDataset(raw_queries)
        corpus_ds = TomoroColQwen3CorpusDataset(raw_corpus)
